...
# ==============================================================
# HÀM GỬI ẢNH QUA TELEGRAM (Đã gỡ bỏ hoàn toàn Streamlit)
# ==============================================================
...
# Khởi tạo Queue chạy ngầm (Đã xóa @st.cache_resource)
...
def trigger_telegram(data, track_id, save_dir, speed_limit_live, violation_type='SPEED'):
    ...
    # Đẩy tác vụ vào luồng Queue để gửi ngầm
    tele_queue.put((TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID, alert_msg, img_path_full, img_path_crop, data.get('best_frame'), data.get('best_crop')))