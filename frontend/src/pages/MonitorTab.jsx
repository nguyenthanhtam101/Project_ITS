...
const MonitorTab = () => {
  ...
  useEffect(() => {
    const fetchCCTV = async () => {
      try {
        const res = await axios.get('https://podcasts-sticker-pairs-therapist.trycloudflare.com/api/admin/table/cameras', {
  ...
  useEffect(() => {
    ...
    if (streamUrl && currentVideoId) {
      interval = setInterval(async () => {
        try {
          const res = await axios.get(`https://podcasts-sticker-pairs-therapist.trycloudflare.com/api/stats/${currentVideoId}`, {
            headers: { "ngrok-skip-browser-warning": "true" }
          });
          if (res.data) {
  ...
  const sendLiveSettings = async (updatedSettings, currentRois) => {
    ...
    try {
      await axios.post(`https://podcasts-sticker-pairs-therapist.trycloudflare.com/api/update-settings/${currentVideoId}`, formData, {
        headers: { "ngrok-skip-browser-warning": "true" }
      });
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (sourceType === 'offline' && selectedFile) {
        ...
        const response = await axios.post('https://podcasts-sticker-pairs-therapist.trycloudflare.com/api/upload-video', formData, {
          headers: { "ngrok-skip-browser-warning": "true" }
        });
        ...
        const response = await axios.post('https://podcasts-sticker-pairs-therapist.trycloudflare.com/api/upload-youtube', formData, {
          headers: { "ngrok-skip-browser-warning": "true" }
        });
        ...
        const response = await axios.post('https://podcasts-sticker-pairs-therapist.trycloudflare.com/api/upload-cctv', formData, {
          headers: { "ngrok-skip-browser-warning": "true" }
        });
        if(response.data.error) {
      ...
      if (resData && resData.video_id) {
        ...
        setStreamUrl(`https://podcasts-sticker-pairs-therapist.trycloudflare.com/api/stream-video/${resData.video_id}?t=${new Date().getTime()}`);
      }
    } catch (error) {
